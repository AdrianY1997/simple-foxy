...
export type FoxyComponentTypographyVariant =
  | "h1"
  | "h2"
  | "h3"
  | "h4"
...
export type FoxyComponentTypography =
  React.ComponentPropsWithoutRef<FoxyComponentTypographyElement> & {
    args?: any;
  };
...
export type FoxyComponentTypographyVariantGetter =
  React.ComponentPropsWithoutRef<FoxyComponentTypographyElement> & {
...
export type OverridableTypography =
  React.ComponentPropsWithoutRef<FoxyComponentTypographyElement> & {
    variant?: FoxyComponentTypographyVariant;
    children: React.ReactNode;
    args?: any;
