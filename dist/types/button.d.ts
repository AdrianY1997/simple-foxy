...
export type FoxyComponentButtonTransform = "capitalize" | "uppercase" | "lowecase";
export type OverridableFoxyButtonBase = React.ComponentPropsWithoutRef<"button"> & {
    border?: 1 | 2 | 3 | 4 | 5;
...
export type OverridableFoxyButton = ((OverridableFoxyButtonBase & {
