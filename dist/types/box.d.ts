...
export type FoxyComponentBoxSection = React.ComponentPropsWithoutRef<"section"> & {
    children?: React.ReactNode;
    args?: any;
};
...
export type OverridableBox = React.ComponentPropsWithoutRef<FoxyComponentBoxType> & {
