...
const Divider = ({ orientation = "horizontal", size, ...args }) => {
    args.className = (0, classnames_1.default)(global_module_css_1.default[`color-${args.color}`], orientation_module_css_1.default.element, orientation_module_css_1.default[orientation], args.className);
