...
const Button = ({ size, variant = "text", color = "default", startIcon, endIcon, children, transform, rounded = "mn", border, ...args }) => {
    ...
    args.className = (0, classnames_1.default)(global_module_css_1.default[`${color}`], button_module_css_1.default.element, button_module_css_1.default[`${color}`], button_module_css_1.default.container, button_module_css_1.default[`rounded-${rounded}`], button_module_css_1.default[rounded ? "rounded" : ""], button_module_css_1.default[`${variant}`], args.className);
    const contentClass = (0, classnames_1.default)(button_module_css_1.default.content, button_module_css_1.default[`rounded-${rounded}`], button_module_css_1.default[rounded ? "rounded" : ""], button_module_css_1.default[variant === "outlined" ? `border-${border || 1}` : `border-${border}`], button_module_css_1.default[`${size}`], transform);
